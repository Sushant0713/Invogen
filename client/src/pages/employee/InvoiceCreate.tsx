...
export default function EmployeeInvoiceCreate() {
  ...
  const { data: templates, isLoading: loadingTemplates } = useQuery({
    queryKey: ['employee-templates-list'],
    queryFn: async () => (await api.get('/employee/templates')).data.data,
  });

  const mutation = useMutation({
    mutationFn: (body: typeof form) => api.post('/employee/invoices', {
      ...body,
